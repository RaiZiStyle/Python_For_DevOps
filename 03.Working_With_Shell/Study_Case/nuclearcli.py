...
Usage : 
    $ ./nuclearcli.py jit-test --jit 
    $ ./nuclearcli.py jit-test
    $ ./nuclearcli.py cuda-operation #Not work, might be cause of cuda drivers
    $ ./nuclearcli.py thread-test 
    $ ./nuclearcli.py thread-test --threads
...
def numerical_real_estate_array(df):
    ...
    columns_to_drop = ['RegionID', 'ZipCode',
